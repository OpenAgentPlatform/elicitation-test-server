...
server.registerTool("test_text_elicitation", {
...
server.registerTool("test_number_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const num = result.content.number;
        return {
            content: [
                {
                    type: "text",
...
server.registerTool("test_boolean_elicitation", {
...
server.registerTool("test_select_elicitation", {
...
server.registerTool("test_multiselect_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const fruits = result.content.fruits;
        return {
            content: [
                {
                    type: "text",
...
server.registerTool("test_email_elicitation", {
...
server.registerTool("test_date_elicitation", {
...
server.registerTool("test_multi_field_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const { username, age, newsletter, theme } = result.content;
        return {
            content: [
                {
                    type: "text",
...
server.registerTool("test_optional_field_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const { email, phone, website } = result.content;
...
server.registerTool("test_multi_step_elicitation", {
    ...
    results.push(`Language: ${step2.content.language}`, `Notifications: ${step2.content.notifications ? "Enabled" : "Disabled"}`);
    // Step 3: Confirmation
    ...
    const confirmed = step3.content.confirm;
    if (confirmed) {
        return {
            content: [
                {
...
server.registerTool("test_titled_enum_elicitation", {
...
server.registerTool("test_titled_multiselect_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const features = result.content.features;
        return {
            content: [
                {
                    type: "text",
...
server.registerTool("test_all_types_elicitation", {
    ...
    if (result.action === "accept" && result.content) {
        const { stringField, integerField, numberField, booleanField, enumField } = result.content;
        return {
            content: [
                {
                    type: "text",
